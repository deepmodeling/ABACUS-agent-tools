"""Validation logic for EOS parameters."""
from typing import Dict, Tuple, List, Any
from ..common import BaseParameterValidator, ValidationResult
from .schema import EOSParameters
class EOSParameterValidator(BaseParameterValidator):
    def validate_all(self, params: EOSParameters, context: Dict[str, Any]) -> Tuple[bool, List[ValidationResult]]:
