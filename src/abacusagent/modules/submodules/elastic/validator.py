"""Validation logic for Elastic parameters."""
from typing import Dict, Tuple, List, Any
from ..common import BaseParameterValidator, ValidationResult
from .schema import ElasticParameters
class ElasticParameterValidator(BaseParameterValidator):
    def validate_all(self, params: ElasticParameters, context: Dict[str, Any]) -> Tuple[bool, List[ValidationResult]]:
...
__all__ = ["ElasticParameterValidator", "ValidationResult"]
