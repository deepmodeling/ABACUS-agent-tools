...
def abacus_plot_band(band_work_path,
    ...
    plt.ylabel(r"$E-E_\text{fermi}$/eV")
...
def abacus_cal_band(stru_file: str,
    ...
    For hybrid DFT bands, the calculation uses converged GGA DFT charge (default is PBE) in nscf calculation, and the
    density functional name should be specified using hybrid_dft_functional.
    Args:
        ...
        band_pic_path: Path to save plotted band.
    ...
    Returns:
        The bandgap of the structure and path to the plotted band.
...
if __name__ == '__main__':
    ...
    stru_file = '/mnt/e/temp/NiO-opted.STRU'
    stru_type = 'abacus/stru'
    extra_input = {'dft_plus_u': 1,
                   'orbital_corr': '2 -1',
                   'hubbard_u': '7.0 0.0',
                   'kspacing': 0.35}
